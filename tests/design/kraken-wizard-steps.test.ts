...
describe("Kraken wizard step pill styles", () => {
  it("uses explicit high-contrast hex colors with scoped selectors", () => {
    ...
    expect(css).toContain(".kraken-wizard .wizard-steps .wizard-steps__button {");
    expect(css).toContain(".kraken-wizard .wizard-steps .wizard-steps__item--active .wizard-steps__button {");
    expect(css).toContain(".kraken-wizard .wizard-steps .wizard-steps__item--done .wizard-steps__button {");
    ...
    expect(css).toContain(".step-nav-popover {");
